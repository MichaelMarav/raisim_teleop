...
#include "raisim_teleop/TalosStepPlanner2D.h"
#include "raisim_teleop/talos_raisim_teleop.h"


/*
Callback to get data from the /talos_raisim_ros/CoM topic
*/
...
/*
Callback to get data from the /talos_raisim_ros/RLeg/odom topic
*/
...
/*
Callback to get data from the /talos_raisim_ros/LLeg/odom topic
*/
...
int main(int argc, char **argv)
{
  ...
  ros::init(argc, argv, "talos_raism_teleop"); // Initialize node
  ...
  nh.getParam("/talos_teleop/num_steps",num_steps);
  nh.getParam("/talos_teleop/velocity_x",speed_x);
  nh.getParam("/talos_teleop/velocity_y",speed_y);
  nh.getParam("/talos_teleop/angular_velocity",speed_w);
  nh.getParam("/talos_teleop/ros_rate_value",ros_rate_value);
  nh.getParam("/talos_teleop/robot_name",robot_name);
